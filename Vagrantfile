...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "fernandochef1-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/linux-academy-chef"
  #   chef.validation_client_name = "linux-academy-chef-validator"
  #   chef.validation_key_path = ".chef/linux-academy-chef-validator.pem"
  # end
end
